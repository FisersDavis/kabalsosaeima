...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-16 border-t border-slate-200 bg-white/50 py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          ...
          <div className="space-y-2 text-xs text-slate-500">
            <div className="font-semibold text-slate-900">Oficiālie datu avoti:</div>
        ...
        <div className="rounded-xl border border-slate-200/80 bg-slate-50 p-3 text-[11px] text-slate-500 leading-relaxed">
          <strong className="text-slate-700">Metodoloģiskā piezīme:</strong> Saeimas procedūrā statusā <em>Nebalsoja</em> tiek iekļauti deputāti, kuri ir reģistrējušies sēžu zālē, bet nav nospieduši nevienu no balsošanas pogām (bieži izmantota taktika kvoruma noraušanai), kā arī deputāti, kuri balsojuma brīdī nebija klātesoši. Visi dati tiek atjaunoti automātiski pēc katras kārtējās ceturtdienas sēdes.
        </div>
